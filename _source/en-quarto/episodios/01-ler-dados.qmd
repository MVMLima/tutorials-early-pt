...
- Download [ebola_cases_2.csv](../data/ebola_cases_2.csv) and [marburg.zip](../data/Marburg.zip) CSV files, and save them inside the `data/` folder.
...
Download this [zip file](../data/Marburg.zip) containing Marburg outbreak data and then import it to your `R` environment.
